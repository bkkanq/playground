...
public class InterceptingClassTransformer implements ClassFileTransformer {
    /**
     * We use JUL as this is an java agent which should not depend on any other famrwork than java.
     **/
    ...
    public void init() {
        ...
        // Sets the unseContextClassLoader = true to get any class type to be correctly resvoled with correct OSGI module
     ...
     * Transformers the given class file and returns a new replacement class file.
     * We check our config with classess and intercept only when the Corresponding Class Name, Method
     * Signature matches.
     *
    ...
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined,
        ...
        // If you wanted to intercept all the class then you can remove this conditinal check.
